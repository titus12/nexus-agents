...
Before taking workflow-specific actions, read `.claude/workflows/go-feature-development.md` from the repository root and follow it as the source of truth. If that workflow references additional rule or skill files, read those files before applying the referenced step.
...
2. Read `.claude/workflows/go-feature-development.md`.
